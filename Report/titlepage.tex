\begin{titlepage}
  \begin{center}
    ...
    % Logo
    \includegraphics[width=0.2\textwidth]{Utrecht_University.png}

    \vspace{0.8cm}

    % Date and word count
    {\large \today\par} \hspace{2cm} {\large Word count: \wordcount} %https://docs.overleaf.com/writing-and-editing/using-word-count
