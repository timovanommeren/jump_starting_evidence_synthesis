...
```{r}
model5 <- lme4::lmer(papers_found ~ condition + percent_rel + condition*records + (condition|dataset), REML = F, data = simulation)
summary(model5)
anova(model5, model4)

simulationOutput_normel_model5 <- simulateResiduals(fittedModel = model5, plot = F)
plotResiduals(simulationOutput_normel_model5, simulation$dataset)
```
